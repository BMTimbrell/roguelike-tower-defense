...
export const LEVEL_WAVES = {
    ...
    "level2-2": {
        ...
        waves: [
            ...
            // {
            //     spawns: [
            //         { id: "armouredOrc", count: 6, interval: 1.5 },
            //         { id: "giantOrc", count: 1, interval: 2 },
            ...
            //         { id: "armouredOrc", count: 3, interval: 1.5 },
            //         { id: "giantBee", count: 1, interval: 1 },
            //         { id: "spider", count: 2, interval: 1.2 },
            //         { id: "giantOrc", count: 1, interval: 2 },
    ...
    "level3-2": {
        ...
        waves: [
            ...
            {
                spawns: [
                    { id: "giantArmouredOrc", count: 1, interval: 1.5 },
            ...
            },
            {
                spawns: [
                    ...
                    { id: "orc", count: 8, interval: 0.5 },
                    { id: "redFairy", count: 1, interval: 1 },
                    { id: "giantSpider", count: 1, interval: 1.5 },
                    { id: "spider", count: 5, interval: 0.75 },
                    { id: "wolf", count: 1, interval: 1 },
                    { id: "giantArmouredOrc", count: 1, interval: 1.5 },
                    { id: "armouredOrc", count: 10, interval: 0.5 },
                    { id: "redFairy", count: 1, interval: 1 },
                    { id: "giantBee", count: 1, interval: 1 },
    ...
    "level4-1": {
        ...
        waves: [
            ...
            //     spawns: [
            //         { id: "iceSlime", count: 3, interval: 1 },
            //         { id: "armouredSkeleton", count: 5, interval: 0.5 },
            //         { id: "giantArmouredSkeleton", count: 1, interval: 1 },
            //         { id: "armouredSkeleton", count: 5, interval: 0.5 },
            //         { id: "armouredSlime", count: 2, interval: 0.5 },
            //         { id: "redFairy", count: 1, interval: 1},
            ...
            //         { id: "giantSkeleton", count: 1, interval: 1 },
            //         { id: "giantPolarBear", count: 1, interval: 1 },
            //         { id: "polarBear", count: 10, interval: 0.5},
            //         { id: "redFairy", count: 1, interval: 1},
            //         { id: "fairy", count: 5, interval: 0.5 },
    ...
    "level4-2": {
        ...
        waves: [
            ...
            // {
            //     spawns: [
            //         { id: "armouredOrc", count: 5, interval: 0.5 },
            //         { id: "giantArmouredOrc", count: 1, interval: 0.5 },
            //         { id: "wolf", count: 1, interval: 0.5 },
            //         { id: "redFairy", count: 1, interval: 1 },
            //         { id: "giantPenguin", count: 1, interval: 1 },
            //         { id: "penguin", count: 5, interval: 0.5 },
            ...
            // {
            //     spawns: [
            //         { id: "spider", count: 5, interval: 0.5 },
            //         { id: "giantSpider", count: 1, interval: 1 },
            //         { id: "spider", count: 5, interval: 0.5 },
            //         { id: "wolf", count: 1, interval: 0.5 },
            //         { id: "giantArmouredOrc", count: 1, interval: 0.5 },
    ...
    "level5-1": {
        ...
        waves: [
            ...
            //         { id: "giantSkeleton", count: 1, interval: 1 },
            //         { id: "skeleton", count: 5, interval: 0.5 },
            //         { id: "redFairy", count: 1, interval: 0.5 },
            //         { id: "fairy", count: 2, interval: 0.5 },
            ...
            //         { id: "redFairy", count: 2, interval: 0.5 },
            //         { id: "giantRedFairy", count: 1, interval: 1 },
            //         { id: "redFairy", count: 2, interval: 0.5 },
            //         { id: "giantGhost", count: 1, interval: 1 },
    ...
    "level5-2": {
        ...
        waves: [
            ...
            //         { id: "penguin", count: 3, interval: 0.5 },
            //         { id: "wolf", count: 1, interval: 1 },
            //         { id: "giantWolf", count: 1, interval: 1 },
            //         { id: "wolf", count: 1, interval: 1 },
            //         { id: "redFairy", count: 1, interval: 1 },
            //         { id: "snowman", count: 5, interval: 1 },
            //         { id: "giantSnowman", count: 1, interval: 1 },
            ...
            //         { id: "giantPenguin", count: 1, interval: 1 },
            //         { id: "penguin", count: 3, interval: 0.5 },
            //         { id: "giantOrc", count: 3, interval: 2 },
            ...
            // {
            //     spawns: [
            //         { id: "giantArmouredOrc", count: 8, interval: 2.5 },
            //         { id: "armouredOrc", count: 10, interval: 1 },
            //         { id: "wolf", count: 3, interval: 1 },
            //         { id: "giantWolf", count: 1, interval: 1 },
            //         { id: "wolf", count: 3, interval: 1 },
            ...
            //         { id: "giantSpider", count: 1, interval: 1 },
            //         { id: "spider", count: 5, interval: 1 },
            //         { id: "giantOrc", count: 10, interval: 2 },
            //         { id: "orc", count: 10, interval: 0.5 },
            //         { id: "redFairy", count: 2, interval: 1 },
            //         { id: "wolf", count: 3, interval: 1 },
            //         { id: "giantWolf", count: 1, interval: 1 },
            ...
            //         { id: "giantFairy", count: 1, interval: 1 },
            //         { id: "fairy", count: 3, interval: 0.5 },
            //         { id: "giantSpider", count: 2, interval: 3 },
            //         { id: "wolf", count: 1, interval: 1 }
            //     ],
            //     reward: 700
            // },
            // {
            //     spawns: [
            //         { id: "giantSpider", count: 3, interval: 2 },
            //         { id: "spider", count: 10, interval: 0.75 },
            //         { id: "giantPenguin", count: 1, interval: 1 },
            //         { id: "giantRedFairy", count: 1, interval: 1 },
            //         { id: "redFairy", count: 2, interval: 0.5 },
            //         { id: "giantWolf", count: 1, interval: 1 },
            //         { id: "wolf", count: 1, interval: 1 },
            //         { id: "giantSnowman", count: 3, interval: 1 },
            //         { id: "giantArmouredOrc", count: 5, interval: 2 },
            //         { id: "giantFairy", count: 1, interval: 1 },
            //         { id: "giantOrc", count: 3, interval: 1 },
            //         { id: "giantFairy", count: 1, interval: 1 },
            //         { id: "giantWolf", count: 1, interval: 1 },
            //         { id: "wolf", count: 1, interval: 1 },
            //         { id: "giantPenguin", count: 1, interval: 1 },
...
export const TOWERS = {
    ...
    chomper: {
        ...
        description: "Spawns a chomper that follows the path to eat enemies, dealing 100% bonus damage to enemies with 80% or higher remaining health. If the chomper kills the enemy, it persists",
        cost: 200,
        stats: {
            damage: 15,
            range: 2,
...
export const SKILLS = [
    ...
    },
    {
        ...
        description: "Poison attacks have a 30% chance to burn enemies",
        apply(hero) {
            hero.volatileConcoction = true;
            hero.volatileConcoctionChance = 30;
        },
    ...
    },
    {
        ...
        apply(hero) {
            hero.volatileConcoction = true;
            hero.volatileConcoctionChance = 60;
        },
        icon: "sprites/volatile-concoction-skill-icon.png"
    },
    {
